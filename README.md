...
For the server to connect to the Supabase database, you need to provide a PostgreSQL connection string. Create a `.env` file inside the `server/` directory and add the following variable:
...
**Live Server URL:** [https://dynamic-configuration-driven-dashboard.onrender.com](https://dynamic-configuration-driven-dashboard.onrender.com)
...
### `GET https://dynamic-configuration-driven-dashboard.onrender.com/api/workspaces`
...
### `GET https://dynamic-configuration-driven-dashboard.onrender.com/api/dashboard-config/:workspace_id`
...
### `POST https://dynamic-configuration-driven-dashboard.onrender.com/api/admin/workspace-config`
...
### `PUT https://dynamic-configuration-driven-dashboard.onrender.com/api/dashboard-config/:workspace_id/status`
